...
<?php 	} ?>
			...
			<li>
				...
				<a href="<?php  echo $urlad_candatur  ?>/candidature_preselectionee/">Candidatures préselectionnées</a>
			...
			<li>
				...
				<a href="<?php  echo $urlad_candatur  ?>/candidature_non_preselectionnee/">Candidatures non préselectionnées</a>
			...
			<li>
				...
				<a href="<?php  echo $urlad_candatur  ?>/candidature_convoque_ecrit/">Candidatures convoquées à l'écrit</a>
			...
			<li>
				...
				<a href="<?php  echo $urlad_candatur  ?>/candidature_confirme_ecrit/">Candidatures confirmées l'écrit</a>
			...
			<li>
				...
				<a href="<?php  echo $urlad_candatur  ?>/candidature_non_confirme_ecrit/">Candidatures non confirmées l'écrit</a>
			...
			<li>
				...
				<a href="<?php  echo $urlad_candatur  ?>/candidature_present_ecrit/">Candidatures présentes à l'écrit</a>

			</li>
			
			<li>

				<a href="<?php  echo $urlad_candatur  ?>/candidature_absent_ecrit/">Candidatures absentes à l'écrit</a>

			</li> 
			
			<li>

				<a href="<?php  echo $urlad_candatur  ?>/candidature_non_admissible/">Candidatures non admissibles</a>

			</li> 
			
			<li>

				<a href="<?php  echo $urlad_candatur  ?>/candidature_admissible/">Candidatures admissibles</a>
			...
			<li>
				...
				<a href="<?php  echo $urlad_candatur  ?>/candidature_convoque_oral/">Candidatures convoquées à l'oral</a>
			...
			<li>
				...
				<a href="<?php  echo $urlad_candatur  ?>/candidature_confirme_oral/">Candidatures confirmées l'oral</a>
			...
			<li>
				...
				<a href="<?php  echo $urlad_candatur  ?>/candidature_non_confirme_oral/">Candidatures non confirmées l'oral</a>

			</li>
			
			<li>

				<a href="<?php  echo $urlad_candatur  ?>/candidature_present_oral/">Candidatures présentes à l'oral</a>

			</li> 
			
			<li>

				<a href="<?php  echo $urlad_candatur  ?>/candidature_absent_oral/">Candidatures absentes à l'oral</a>

			</li> 
			
			<li>

				<a href="<?php  echo $urlad_candatur  ?>/candidature_non_admis/">Non admis</a>

			</li> 
			
			<li>

				<a href="<?php  echo $urlad_candatur  ?>/candidature_liste_attente/">Liste d'attente</a>

			</li> 
			
			<li>

				<a href="<?php  echo $urlad_candatur  ?>/candidature_admis/">Admis</a>
