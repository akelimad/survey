<h1><?php trans_e("Mes identifiants"); ?></h1>

<div class="styled-title mt-10 mb-10">
  <h3><?php trans_e("Vous souhaitez changer votre mot de passe ?"); ?></h3>
</div>
...
<form method="POST" action="<?= site_url('candidat/change-password'); ?>" class="chm-simple-form" onsubmit="return window.chmForm.submit(event)">
  ...
  <div class="row pl-xs-15 pr-xs-15">
    <div class="required">
      <label for="current_password" class="col-sm-4 p-xs-0 mt-5"><?php trans_e("Votre mot de passe actuel"); ?></label>
  ...
  <div class="row pl-xs-15 pr-xs-15">
    <div class="required">
      <label for="password" class="col-sm-4 p-xs-0 mt-5"><?php trans_e("Nouveau mot de passe"); ?></label>
  ...
  <div class="row pl-xs-15 pr-xs-15">
    <div class="required">
      <label for="confirm_password" class="col-sm-4 p-xs-0 mt-5"><?php trans_e("Confirmer le nouveau mot de passe"); ?></label>
