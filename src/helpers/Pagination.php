...
class Pagination
{
    ...
    */
    ...
    protected function build_links()
    {
         ...
         * Start the UL
         */
        $this->links_html = '<ul class="'.$this->options['class_ul'].' mt-0">'.PHP_EOL;
    ...
    public function build_li_element($class, $text, $is_link = false, $page_number = 0)
    {
        if($is_link == false)
        {
            $this->links_html .= '<li class="'.$class.'"><a class="active">'.$text.'</a></li>'.PHP_EOL;
        }
        else
        {
    ...
    protected function build_links_next_last()
    {
        ...
        if($this->options['show_links_prev_next'] == true)
        {
            ...
            {
                $this->links_html .= '<li  class="'.$this->options['class_dead_links'].'"><a class="active">'.$this->options['text_next'].'</a></li>'.PHP_EOL;
            }
        ...
        if($this->options['show_links_first_last'] == true)
        {
            ...
            {
                $this->links_html .= '<li class="'.$this->options['class_dead_links'].'"><a class="active">'.$this->options['text_last'].'</a></li>'.PHP_EOL;
            }
            elseif($this->current_page != $this->total_pages)
            {
