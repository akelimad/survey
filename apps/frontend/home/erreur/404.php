...
$ariane=" Accueil > Page non trouvée";		
?>
<!DOCTYPE html >
...
<body>
    ...
    <div id='container'>
        ...
        <div id='gauche'>
            ...
            <div id="content_d"> 
                <div id="moteur">
                    <br><br><center> <strong> <h1>Page non trouvée</h1>
                    <div>Malheureusement, nous avons du mal à charger la page que vous recherchez. Veuillez attendre un instant et réessayer ou utiliser les actions ci-dessous.</div>
                </div>
            </div>
        </div>
    </div>
