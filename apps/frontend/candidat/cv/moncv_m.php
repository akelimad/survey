...
<?php    include("traitement.php");?>
    ...
    <br/>
        ...
        <tr>
          ...
          <td class="subscription" style="width:50%"><h1>Mes informations : </h1></td>
        ...
        <tr>
          ...
          <ul>
            ...
            <b><?php 
              ...
              $requet0=mysql_query("select * from prm_situation where id_situ= ".safe($reponse['id_situ'])." "); 
            ...
            <li style="list-style-type: none;"><i class="fa fa-plus"></i>
              ...
              <span class="Style2"> Fonctions souhaités</span> :

            <b><?php

            $requet11=mysql_query("select * from prm_fonctions where id_fonc= ".safe($reponse['id_fonc'])." "); 
            ...
            <li style="list-style-type: none;"><i class="fa fa-plus"></i>
              ...
              <span class="Style2"> Secteur souhaité :</span> :

            <b><?php

            $requet13=mysql_query("select * from prm_sectors where id_sect= ".safe($reponse['id_sect'])." "); 
            ...
            $requet22=mysql_query("select * from prm_type_formation where id_tfor= ".safe($reponse['id_tfor'])." "); 
            ...
            $requet23=mysql_query("select * from prm_niv_formation where id_nfor= ".safe($reponse['id_nfor'])." "); 
          ...
          <td>
            ...
            $requet16=mysql_query("select * from prm_disponibilite where id_dispo= ".safe($reponse['id_dispo'])." "); 
            ...
            <li style="list-style-type: none;"><i class="fa fa-plus"></i>
              ...
              <span class="Style2"> Salaire souhaité :</span> :

            <b><?php

            $requet14=mysql_query("select * from prm_salaires where id_salr= ".safe($reponse['id_salr'])." "); 
            ...
            $requet15=mysql_query("select * from prm_situation where id_situ= ".safe($reponse['id_situ'])." "); 
            ...
            <li style="list-style-type: none;"><i class="fa fa-plus"></i><span class="Style2"> Mobilite</span> :
        ...
        <thead>
          ...
          <tr>
            ...
            <td class="subscription" style="width:88%"><h1> Mon CV  </h1></td>
...
$id_cnadidat=$_SESSION['abb_id_candidat'];
      ...
      $requetlettre=   mysql_query("select * from lettres_motivation where candidats_id = '".safe($id_cnadidat)."'  AND actif=1");
   ...
   $i=1;
      ...
      ?>
            ...
            $requet12=mysql_query("select * from prm_civilite where id_civi= ".safe($reponse['id_civi'])." "); 
            ...
            <?php $req = mysql_query("SELECT * from  candidats where candidats_id = '".safe($reponse['candidats_id'])."' ");
 ...
 $formation=mysql_query("SELECT * from formations where candidats_id= ".safe($reponse['candidats_id'])." order by date_fin asc");
...
<?php 
 ...
 while ($resultat1 = mysql_fetch_array($formation)) {

$req_03 = mysql_query( "SELECT * FROM prm_ecoles where id_ecole=".safe($resultat1['id_ecol'])." ");    

$r03 = mysql_fetch_array( $req_03 ) ; 

if ($resultat1['id_ecol']!='290') { $type=$r03['nom_ecole'];} else {$type=$resultat1['ecole'];}

$ecole=mysql_query("SELECT * from prm_ecoles where id_ecole= ".safe($resultat1['id_ecol'])." "); 

if($ecole){ 

$resultecole=mysql_fetch_assoc($ecole) ;}

$paysecole=mysql_query("SELECT * from prm_pays where id_pays= ".safe($resultecole['id_pays'])." "); 

if($paysecole){ 

$resultpaysecole=mysql_fetch_assoc($paysecole) ;}

$nivformation=mysql_query("SELECT * from prm_niv_formation where id_nfor= ".safe($resultat1['nivformation'])." "); 
...
$req_theme = mysql_query("SELECT * FROM prm_filieres where id_fili= ".safe($resultat1['diplome'])." "); 
...
$orderdate_dd = explode('/', $resultat1['date_debut']); 
...
if(!empty($resultat1['date_fin'])){

$orderdate_df = explode('/', $resultat1['date_fin']);
...
?>
            ...
            <tr>
              ...
              if(empty($resultat1['date_fin'])){echo " - Aujourd'hui";}
...
$secteur=mysql_query("select * from prm_sectors where id_sect= ".safe($resultat['id_sect'])." "); 

if($secteur){ 

$resultexteur=mysql_fetch_assoc($secteur) ;}

$fonction=mysql_query("select * from prm_fonctions where id_fonc= ".safe($resultat['id_fonc'])." "); 

if($fonction){ 

$resultfonction=mysql_fetch_assoc($fonction) ;}

$typeposte=mysql_query("select * from prm_type_poste where id_tpost= ".safe($resultat['id_tpost'])." "); 

if($typeposte){ 

$resulttypeposte=mysql_fetch_assoc($typeposte) ;}

$payseexp=mysql_query("select * from prm_pays where id_pays= ".safe($resultat['id_pays'])." "); 
...
switch( $expemonth_dd){case '01': $m_dd='Janvier';break;case '02': $m_dd='Février';break;case '03': $m_dd='Mars';break;case '04': $m_dd='Avril';break;case '05': $m_dd='Mai';break;case '06': $m_dd='Juin';break;case '07': $m_dd='Juillet';break;case '08': $m_dd='Août';break;case '09': $m_dd='Septembre';break;case '10': $m_dd='Octobre';break;case '11': $m_dd='Novembre';break;case '12': $m_dd='Décembre';break;}



switch( $expmonth_df){case '01': $m_df='Janvier';break;case '02': $m_df='Février';break;case '03': $m_df='Mars';break;case '04': $m_df='Avril';break;case '05': $m_df='Mai';break;case '06': $m_df='Juin';break;case '07': $m_df='Juillet';break;case '08': $m_df='Août';break;case '09': $m_df='Septembre';break;case '10': $m_df='Octobre';break;case '11': $m_df='Novembre';break;case '12': $m_df='Décembre';break;}
...
<br/>
   ...
   <td  class="cvlettre" id="sup_cv0_<?php echo $id_cv; ?>" >
      ...
      echo '<a href="./langues_pj/dcv/?cv='.$lien_cv.'"> <i class="fa fa-download fa-lg" ></i></a>';
...
//echo '<span  id="leschampscv_'.$cvnbr2.'"><a class="cvchamp" href="javascript:create_champcv('.$cvnbr2.')">Ajouter un CV</a></span>';
  ...
  <?php 
      ...
      $requetlm=   mysql_query("select * from lettres_motivation where candidats_id = '". $id_cnadidat."'  AND actif=1");

      $nbr=mysql_num_rows($requetlm);
...
<label>Lettre de motivation</label> <br/>
   ...
   $i=1;
        ...
        while($resutl=mysql_fetch_assoc($requetlm))
   ...
   <td class="cvlettre" id="sup_lettre_<?php echo $id_cv; ?>" >
      ...
      echo '<a href="./langues_pj/dlm/?cv='.$lien_cv.'"> <i class="fa fa-download fa-lg" ></i></a>';
