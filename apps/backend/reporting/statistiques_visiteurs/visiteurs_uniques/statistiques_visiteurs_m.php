...
<tr>
                            ...
                            <select onChange="window.location.href=this.value">
                                <option value="../visiteurs_uniques/" selected="selected">Nombre de visiteurs uniques  </option>
                                <option value="../pages_vues/">Nombre des pages vues  </option>
...
<?php       include ( "./statistiques_visiteurs_1.php"); ?>
