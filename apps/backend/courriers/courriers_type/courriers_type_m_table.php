                            ...
                            $trcolor='bgcolor="#DDDDDD"';
                                ...
                                ?>          
                                    ...
                                    <tr <?php echo $trcolor; ?> onmouseover="this.className='marked'" onmouseout="this.className=''" >
                                        ...
                                        <div style=" float: left; padding-left: 5px; "><a href="javascript:void(0)" onclick="if(confirm('Êtes-vous sûre de vouloir supprimer ce message?'))location.href='?action=delete&id=<?php echo $reponse['id_email'] ?>'">
