...
/*---------------------------- fonction ,age, and sexe ----------------------*/
$m12 =  (isset($_SESSION['fonction'])) ? $_SESSION['fonction'] : "";
$m13 =  (isset($_SESSION['sexe'])) ? $_SESSION['sexe'] : "";
$m14 =  (isset($_SESSION['age'])) ? $_SESSION['age'] : "";
/*---------------------------- end(fonction ,age, and sexe) ----------------------*/
...
if (!empty($_SESSION['motcle']) || !empty($_SESSION['fonction']) 
  ...
  || !empty($_SESSION['sexe']) || !empty($_SESSION['age'])) {
...
//------------------------------ end age --------------------------------------
//------------------------------ sexe -----------------------------------------
if (!empty($_SESSION['sexe']))
{
if($_SESSION['sexe']=="1"){
$requete .= " And candidats.id_civi =1";

}else if($_SESSION['sexe']=="2"){
