...
" . $requete . " and id_civi = 0 and nom ='' and prenom ='' or last_connexion = '0000-00-00'
...
$selectString = "SELECT * from  candidats   where  id_civi = 0 and nom ='' and prenom ='' or last_connexion = '0000-00-00'  ".$g_by."  
