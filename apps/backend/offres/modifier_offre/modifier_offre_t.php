...
if (!isset($_SESSION["abb_admin"]) || $_SESSION["abb_admin"] == "") {
    header("Location: ../../login/"); 
        ...
        $rep_roles = mysql_fetch_assoc($sql_roles);
                  ...
                  $id_off = isset($_POST['id']) ? intval(trim($_POST['id'])) : ""; 
                  $id_off_m = isset($_POST['id_off_m']) ? trim($_POST['id_off_m']) : $id_off;
...
$r_details = $r01['Details']; $r_profil= $r01['Profil'];$r_date_expiration= $r01['date_expiration'];$r_contact= $r01['Contact']; 
...
$ariane=" Offres > Modifier une offre"; 
