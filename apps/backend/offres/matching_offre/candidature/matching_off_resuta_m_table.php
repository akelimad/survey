...
$is=$inum+$limitstart;
		 ...
		 /*==================================================================================================================================*/
		   ...
		   $ref_candidats = mysql_query("SELECT * FROM candidats  WHERE candidats_id = '".$return_g['candidats_id']."' limit 0,1");
            ...
            $s_pertinence_sql = "SELECT * FROM pertinence_oc    WHERE candidats_id = '".$return['candidats_id']."'     and id_offre = '".$id_offre."'     and ref_p = 'm' limit 0,1";
			...
			$select_model = mysql_query("select * from lettres_motivation  where  candidats_id = ".$return['id_candidature']." ");           
