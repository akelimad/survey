...
?>
 ...
 <?php
    ...
    if( isset($_SESSION['id_offre'])  )
    {
		...
		$query_M="	SELECT  candidats_id FROM candidats   WHERE   candidats_id  NOT IN ( SELECT candidats_id FROM candidature WHERE id_offre=".$id_offre." ) order by dateMAJ desc ";
