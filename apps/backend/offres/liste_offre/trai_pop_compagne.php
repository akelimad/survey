...
var rel02=c;
    ...
    if (document.getElementById) { // DOM3 = IE5, NS6 
        ...
        if (document.layers) { // Netscape 4 
            ...
            var id_candidat1 = '<input type="hidden" value="'+rel02+'" name="id_offre" />';
    ...
    $(document).ready(function(){
        ...
        $('#form_pop_dossier').submit(function(){
...
<div id="repertoire_dossier"  style="visibility: hidden;" ><div id="fils_dossier">
        ...
        <div class="popup_block_dossier" style="width: 560px; z-index: 999; top: 10%; left: 25%;">
            ...
            <div class="titleBar_dossier">
                ...
                <div class="title_dossier">Formulaire d'affectation au campagne recrutement </div>
            ...
            <div id="content_dossier" class="content_dossier" style="height: 100%;">
                ...
                <form action="" id="form_pop_dossier" method="post">
                    ...
                    <table border="0" cellspacing="0" cellpadding="2" align="center">
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                ...
                                <div class="subscription" style="margin: 10px 0pt;">
                                    ...
                                    <h1>Affectation au campagne recrutement  </h1>
                        ...
                        <tr>
                            ...
                            <td width="35%"><b>Nom du campagne recrutement  </b></td>

                            <td width="75%">

                                <select name="compagne">

									 <option value=""></option>

								  <?php			$req_ci = mysql_query( "SELECT * FROM campagne_recrutement");				

								  while ( $ci = mysql_fetch_array( $req_ci ) ) {	

								  

								  $ds_nom = $ci['titre_compagne'];	 $ds_id = $ci['id_compagne'];						
