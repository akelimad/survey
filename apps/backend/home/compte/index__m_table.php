...
$select_candidature = mysql_query("SELECT  candidature.id_candidature FROM  candidature,agenda 

where   agenda.id_candidature=candidature.id_candidature  

".$offre_candidatures."  and  candidature.status = 'En cours'  ");
...
include('index__m_table_traitement.php');                                          
...
$age = (time() - strtotime($reponse2['date_n'])) / 3600 / 24 / 365;
...
echo ' <tr style=" background-color: #ededed; "> <td colspan="8">';
