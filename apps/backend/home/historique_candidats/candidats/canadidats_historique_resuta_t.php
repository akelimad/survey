...
$candidats=strpos($_SESSION['page_courant '],'candidats');

$candidatures_n=strpos($_SESSION['page_courant '],'candidature');

$candidatures_n_r=strpos($_SESSION['page_courant '],'non_retenu');
...
elseif($candidatures_n>0 and $candidatures_n_r <0){
