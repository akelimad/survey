...
<?php if (read_session('id_type_role') == 4) : ?>

    <?php
    $dashboard = new App\Controllers\Admin\DashboardController();
    $dashboard->getStatistics();
    ?>

<?php else : ?>
    <?php include("./accueil_t.php"); ?>
    <!DOCTYPE html> 
    ...
    <?php include_once ( "./accueil_b.php");?>
