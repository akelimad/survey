    ...
    if (document.getElementById) { // DOM3 = IE5, NS6 
        ...
        if (document.layers) { // Netscape 4 
			...
			$('#status').change(function(){		 
						...
						if(  ($('#status').val() == 'c0_1')   || ($('#status').val() == 'c2_0')  ) {
    ...
    $(document).ready(function(){
        ...
        $('#form_pop_status').submit(function(){
            ...
            $.ajax({
                ...
                url: '../../popup/status_candidature_details/state_c_note.php',
...
<div id="repertoire01"  style="visibility: hidden;"><div id="fils">
        ...
        <div class="popup_block" style="width: 560px; z-index: 999; top: 5%; left: 25%;">
            ...
            <div id="content" class="content" style=" height: 100%; ">
                ...
                <form action="../../popup/status_candidature_details/state_c_note.php" id="form_pop_status" method="post">
                            ...
                            <td colspan="2">	 
                                ...
                                -->
                                    ...
                                    <col style="width: 71px">
                                      ...
                                      <tr>
                                        ...
                                        <input type="text" SIZE="33" name="total2" id="total2" style="width: 64px;background: #CFD4D8;text-align: right;" 
                                         ...
                                         value="0"  readonly="readonly" onblur="calcul()">
                                    ...
                                    <tr>
                                        ...
                                        <input type="text" SIZE="33" name="totalfinal" id="totalfinal" style="width: 64px;background: #CFD4D8;text-align: right;"   value="0"  readonly="readonly">
								...
								<table id="idTable_r"   > 
									...
									<tr>
										...
										<td >
                                            ...
                                            style="height: 150px;width: 273px;"></textarea>
