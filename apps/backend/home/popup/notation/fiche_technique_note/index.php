...
<?php include ( dirname(__FILE__) . $tempurl4 . "/header_tmp_admin.php"); ?>  
...
<?php     include ( dirname(__FILE__) . $tempurl4 . "/header_admin.php");       ?>
...
if (strpos($_SESSION['page_courant '],'offres') !== false) {
     ...
     include ( dirname(__FILE__) . $menuurl4 . "/menu_g_a_offres.php"); 

}elseif (strpos($_SESSION['page_courant '],'candidats') !== false) { 

     include ( dirname(__FILE__) . $menuurl4 . "/menu_g_a_candidats.php"); 

}elseif (strpos($_SESSION['page_courant '],'candidatures') !== false) {

     include ( dirname(__FILE__) . $menuurl4 . "/menu_g_a_candidature.php");  

}elseif (strpos($_SESSION['page_courant '],'backend') !== false) {

     include ( dirname(__FILE__) . $menuurl4 . "/menu_g_a_accueil.php");  
        ...
        $sum_not1_final = ($sum_not1 / 100)* 0.4;

        $sum_not1_final1 = $sum_not1_final * 100;

		//$sum_not1_final1 = number_format($sum_not1_final1, 2, ',', ' ');

		

        $sum_note2_final = ( ( ($sum_note2 / 40) * 2.5) * 0.6);

        $sum_note2_final1 = $sum_note2_final * 100;
			...
			<div class='texte' style="width:825px;">
                    ...
                    <img src="<?php echo $imgurlban.$logo; ?>" title="LPEE" style="height: 60px;"/></div>
						  	...
						  	<br/>
								...
								<h1><center>FICHE TECHNIQUE </center></h1>

						  	<br/>

						<center><h2> Offre : <b> <?php echo ''.$reponse['Name'].''; ?> </b> </b></h2> </center>
...
<?php include ( dirname(__FILE__) . $tempurl4 . "/footer_admin.php"); ?> 



<?php include ( dirname(__FILE__) . $tempurl4 . "/footer_tmp_admin.php"); ?>
