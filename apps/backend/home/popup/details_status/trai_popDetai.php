...
<?php
											...
											$req_com_m="UPDATE `historique` SET `commentaire` = '".$_POST['titre_m']."' WHERE `historique`.`id` = ".$id_hie."";

											$sql_upd=mysql_query($req_com_m);
		...
		echo $show;										 
											...
											$sql_delete="UPDATE `historique` SET `commentaire` ='' WHERE `historique`.`id` = ".$id_his."";

											$sql_delet=mysql_query($sql_delete);
