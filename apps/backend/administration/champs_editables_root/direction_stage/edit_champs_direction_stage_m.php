...
<table  width="100%"  border="0" cellspacing="2" cellpadding="2">
    ...
    <td scope="col" width="13%" style="border:1px solid #FFFFFF;" >Ajouter Direction de stage : </td>

    <td scope="col" width="23%" style="border:1px solid #FFFFFF;" >

        <textarea required name="direction" rows="1" cols="50" maxlength="100" ></textarea>
...
if(isset($_POST['sendAdd_tf']) and $_POST['direction']!="")

{

$addSect = mysql_query("INSERT INTO prm_direction_stage (nom_direction) 

  VALUES ('".safe($direction)."')");
...
if(isset($_POST['send_tf']) and $_POST['direction']!="")

{

$update = mysql_query("UPDATE prm_direction_stage set nom_direction='".safe($direction)."' 

  where id_prm_stage='".safe($id)."' ");
...
$delet = mysql_query("DELETE from prm_direction_stage where id_prm_stage='$id'");
...
<?php
    ...
    $sql = "select * from prm_direction_stage ";

    $select = mysql_query($sql);

    if((isset($_POST['send_tf']) and $_POST['send_tf']!="" )or (isset($_POST['delet_tf']) and $_POST['delet_tf']!="") or (isset($_POST['sendAdd_tf']) and $_POST['sendAdd_tf']!="" and $_POST['direction']!="" ))
...
?>
 ...
 <tr  onmouseover="this.className='marked'" onmouseout="this.className=''" > 
    ...
    <textarea  name="direction" rows="1" cols="50" maxlength="100" ><?php echo $reponse['nom_direction']; ?></textarea></td>

    <td style="border:1px solid #FFFFFF;">

    <input type="hidden" name="id" value="<?php echo $reponse['id_prm_stage']; ?>" >
