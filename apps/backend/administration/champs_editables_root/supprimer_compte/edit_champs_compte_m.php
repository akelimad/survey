...
<table  width="100%"  border="0" cellspacing="2" cellpadding="2">
    ...
    <td scope="col" width="13%" style="border:1px solid #FFFFFF;" >Ajouter une raison :  </td>
...
$addSect = mysql_query("INSERT INTO prm_compte_desactiver (id_prm_compte,raison) 

  VALUES ('','".safe($type_role)."' )");
...
$update = mysql_query("update prm_compte_desactiver set raison='".safe($type_role)."' where id_prm_compte='".safe($id)."' ");
...
$delet = mysql_query("delete from prm_compte_desactiver where id_prm_compte='$id'");
...
?>
 ...
 <tr  onmouseover="this.className='marked'" onmouseout="this.className=''" > 
    ...
    <textarea  name="type_role" rows="1" cols="50" maxlength="100" ><?php echo $reponse['raison']; ?></textarea></td>

    <td style="border:1px solid #FFFFFF;">

		<input type="hidden" name="id" value="<?php echo $reponse['id_prm_compte']; ?>" >
