...
<table  width="100%"  border="0" cellspacing="2" cellpadding="2">
    ...
    <td scope="col" width="13%" style="border:1px solid #FFFFFF;" >Ajouter pays : </td>

    <td scope="col" width="23%" style="border:1px solid #FFFFFF;" >

        <textarea required name="pays" rows="1" cols="50" maxlength="100" ></textarea>

    </td>

    <td scope="col" width="8%" style="border:1px solid #FFFFFF;">

        <input name="sendAdd_py" type="hidden" class="btnEnregistrer"  value=" Enregistrer " />
...
if(isset($_POST['sendAdd_py'])  and $_POST['pays']!="")

{

$addSect = mysql_query("INSERT INTO prm_pays (id_pays,pays) VALUES ('','".safe($pays)."')");
...
<table width="100%" border="0" cellspacing="0" id="pays" class="tablesorter" style="background: none;">
...
if(isset($_POST['send_py']) and $_POST['send_py']!="")

{

$update = mysql_query("update prm_pays set pays='".safe($pays)."' where id_pays='".safe($id)."' ");
...
if(isset($_POST['delet_py']) and $_POST['delet_py']!="")

{

$delet = mysql_query("delete from prm_pays where id_pays='$id'");
...
<?php
    ...
    $select = mysql_query($sql);
     ...
     if((isset($_POST['send_py']) and $_POST['send_py']!="" )or (isset($_POST['delet_py']) and $_POST['delet_py']!="") or (isset($_POST['sendAdd_py']) and $_POST['sendAdd_py']!="" and $_POST['pays']!="" ))
...
?>
 ...
 <tr  onmouseover="this.className='marked'" onmouseout="this.className=''" > 
    ...
    <textarea  name="pays" rows="1" cols="50" maxlength="100" ><?php echo $reponse['pays']; ?></textarea></td>

    <td style="border:1px solid #FFFFFF;">

    <input type="hidden" name="id" value="<?php echo $reponse['id_pays']; ?>" >

    <input name="send_py" type="hidden" class="btnEnregistrer"  value="Enregistrer" />               
    ...
    <input name="delet_py" type="hidden" class="btnSupprimer"  value="Supprimer" />              
