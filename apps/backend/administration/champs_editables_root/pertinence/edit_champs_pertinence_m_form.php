<table  width="100%"  border="0" cellspacing="2" cellpadding="2">	
    ...
    <td scope="col" width="30%" style="border:1px solid #FFFFFF;" >Selectionner la page :  </td>

    <td scope="col" width="70%" style="border:1px solid #FFFFFF;" >

        <select name="type_p" class="form-control input-sm" style="width: 200px;">

        <option value="">Selectionner la page</option>

        <option value="1">Postulation</option>
