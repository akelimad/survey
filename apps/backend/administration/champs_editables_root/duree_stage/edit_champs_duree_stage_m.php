...
<table  width="100%"  border="0" cellspacing="2" cellpadding="2">
    ...
    <td scope="col" width="13%" style="border:1px solid #FFFFFF;" >Ajouter duree de stage : </td>

    <td scope="col" width="23%" style="border:1px solid #FFFFFF;" >

        <textarea required name="duree" rows="1" cols="50" maxlength="100" ></textarea>
...
if(isset($_POST['sendAdd_tf']) and $_POST['duree']!="")

{

$addSect = mysql_query("INSERT INTO prm_duree_stage (nom_duree) VALUES ('".safe($duree)."')");
    ...
    $sql = "select * from prm_duree_stage ";
...
if(isset($_POST['send_tf']) and $_POST['duree']!="")

{

$update = mysql_query("UPDATE prm_duree_stage set nom_duree='".safe($duree)."' 

  where id_duree='".safe($id)."' ");
...
$delet = mysql_query("DELETE from prm_duree_stage where id_duree='$id'");
...
<?php
    ...
    if((isset($_POST['send_tf']) and $_POST['send_tf']!="" )or (isset($_POST['delet_tf']) and $_POST['delet_tf']!="") or (isset($_POST['sendAdd_tf']) and $_POST['sendAdd_tf']!="" and $_POST['duree']!="" ))
...
?>
 ...
 <tr  onmouseover="this.className='marked'" onmouseout="this.className=''" > 
    ...
    <textarea  name="duree" rows="1" cols="50" maxlength="100" ><?php echo $reponse['nom_duree']; ?></textarea></td>

    <td style="border:1px solid #FFFFFF;">

    <input type="hidden" name="id" value="<?php echo $reponse['id_duree']; ?>" >
