...
if (isset($_SESSION["r_prm_champs_edit"]) || $_SESSION["r_prm_champs_edit"] == 0) {

    header("Location: ../region/");

}

include ( "../edit_champs_t.php");
...
<?php include ( dirname(__FILE__) . $menuurl3 . "/menu_g_a_admin.php"); ?>
	...
	<?php  include ( "./edit_champs_filiere_m.php"); ?>
