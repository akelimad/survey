...
/////////////////////////////////////////////traitement filtrage/////////////////////////////////////////////////  
        ...
        if(!empty($_SESSION["crc_motcle"])||!empty($_SESSION["crc_fonction"])||!empty($_SESSION["crc_pertinence"])||!empty($_SESSION["crc_fraicheur"])
            ...
            ||!empty($_SESSION["crc_notation"])||!empty($_SESSION["crc_pays"])||!empty($_SESSION["crc_formation"])||!empty($_SESSION["crc_type_formation"])||!empty($_SESSION["crc_exp"])||!empty($_SESSION["crc_secteur"])||!empty($_SESSION["crc_situation"])||!empty($_SESSION["crc_etablissement"])||!empty($_SESSION["crc_ref"])||!empty($_SESSION["crc_campagne"]))
    ...
    =$tab_f=$tab_n_f=$tab_a_f=$tab_c_r=$tab_n_c_r=$tab_a_c_r=$tab_o_c=$tab_n_o_c=$tab_a_o_c="";
...

            {
                    ...
                    $p_f=$_SESSION["crc_pertinence"];if($p_f==10){$p_d=$p_f-10;}else{$p_d=$p_f-20;}

                    $requete .= " And pertinence BETWEEN '".$p_d."' AND '".$p_f."' ";
