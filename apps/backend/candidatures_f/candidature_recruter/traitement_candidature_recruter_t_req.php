...
$result_array =  $array_test =  array();
            ...
            $select_popup_3 = mysql_query("SELECT statut FROM `prm_statut_candidature`where   popup_5=5 " );
        ...
        $select_candidature = mysql_query("SELECT  candidature.candidats_id , candidature.id_candidature,  candidature.id_offre  FROM   candidature   ". $q_offre_fili  ."   ".$offre_candidatures."  and  candidature.status = 'En cours'  ");
       ...
       // if($condition=='WHERE ( id_candidature IN () ) ') $condition=''; 
        ...
        $query = "SELECT  
			...
			candidature.candidats_id , candidature.id_candidature,  candidature.id_offre 
			 ...
			 FROM   candidature    ".$condition."   ".$q_offre_fili_and."  and  candidature.status = 'En cours'   "; 
