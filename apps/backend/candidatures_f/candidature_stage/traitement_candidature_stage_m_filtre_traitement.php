...
if (!empty($_SESSION['cs_motcle']) || !empty($_SESSION['cs_fonction']) || !empty($_SESSION['cs_fraicheur']) || !empty($_SESSION['cs_pays']) || !empty($_SESSION['cs_formation']) || !empty($_SESSION['cs_type_formation']) || !empty($_SESSION['cs_exp']) || !empty($_SESSION['cs_ville'])|| !empty($_SESSION['cs_secteur']) || !empty($_SESSION['cs_situation']) || !empty($_SESSION['cs_etablissement'])
