 ...
 <i class="fa fa-external-link"></i>
      ...
      <span style="width:280px;padding:6px"> 
        ...
        if($cpt){
          ...
          echo ' <h2 style="color:#000;"><b>Historique des actions effectu&eacute;es</b> </h2><div style="background-color: #ddd;"><table width="100%"><thead>

          <tr><td><b>Date</b></td><td><b>Statut</b></td><td><b>Utilisateur</b></td></tr></thead>';
        ...
        { 
          ...
          <!--<a href="javascript:showDivDetai(\''.$idst.'\',\''.$stat.'\',\''.$nomPre.'\',\''.$date.'\',\''.$utilisateur.'\',\''.$lieu.'\',\''.$commentaire.'\',\'\')"  

          title="Voir ce message"><i class="fa fa-search fa-fw fa-lg"></i> </a>
