...
$result_array =  $array_test =  array();
        ...
        $select_candidature = mysql_query("SELECT  candidature.candidats_id , candidature.id_candidature,  candidature.id_offre  FROM   candidature   ". $q_offre_fili  ."   ".$offre_candidatures."   and candidature.status in ('Non retenu', 'Refuse') ");
       ...
       // if($condition=='WHERE ( id_candidature IN () ) ') $condition=''; 
        ...
        $query = "SELECT  
			candidature.candidats_id , candidature.id_candidature,  candidature.id_offre 
			 FROM   candidature    ".$condition."   ".$q_offre_fili_and."   ".$offre_candidatures."  and candidature.status in ('Non retenu', 'Refuse') "; 
