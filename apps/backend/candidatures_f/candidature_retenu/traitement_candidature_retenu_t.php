...
if(!isset($_SESSION['menu3_c'])|| $_SESSION["menu3_c"] == 0) {  header("Location: ../../compte/");    }
...
/////////////////////////////////////////////traitement statut/////////////////////////////////////////////////   
include('traitement_candidature_retenu_t_req.php');
/////////////////////////////////////////////traitement statut///////////////////////////////////////////////// 

             
        
/////////////////////////////////////////////traitement filtrage///////////////////////////////////////////////// 
include('traitement_candidature_retenu_t_filtre.php');     
/////////////////////////////////////////////traitement filtrage/////////////////////////////////////////////////  
...
/////////////   fin pagination
 ...
 $_SESSION['link_bak_b']=42;            
 
        
 $_SESSION['page_courant ']=$_SERVER['REQUEST_URI']; 
    
  $nom_page_site ="CANDIDATURES RETENUES"  ;
 
   

    $ariane=" Candidatures > Traitement des candidatures retenues";
?>