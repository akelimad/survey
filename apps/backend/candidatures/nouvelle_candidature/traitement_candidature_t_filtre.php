...
//------------------------------------------------------------------------------------------
if(isset($_POST["fonction"]) and $_POST["fonction"]!='')  $_SESSION["nc_fonction"]=$_POST["fonction"];  
if(isset($_POST["age"]) and $_POST["age"]!='')  $_SESSION["nc_age"]=$_POST["age"];  
if(isset($_POST["sexe"]) and $_POST["sexe"]!='')  $_SESSION["nc_sexe"]=$_POST["sexe"];  
/////////////////////////////////////////////////////////////////////////////////////////////
...
if(!empty($_SESSION["nc_motcle"])||!empty($_SESSION["nc_fonction"])||!empty($_SESSION["nc_pertinence"])
			...
			|| !empty($_SESSION['nc_sexe']) || !empty($_SESSION['nc_age']))
...
//---------------------age and sexe----------------------------------------------	
  ...
  if(!empty($_SESSION["nc_sexe"]))
            
			{
			if($_SESSION['nc_sexe']=="1"){
			...
			//*************
			  if(!empty($_SESSION["nc_age"]))
            {
			
	if($_SESSION['nc_age']==1){
