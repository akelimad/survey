...
<label>Par mot clé</label><br/><input type="text" name="motcle"  value="<?php  if(!empty($_SESSION["crt_motcle"])) echo  $_SESSION["crt_motcle"] ; ?>" style="width: 187px;" maxlength="100" />
...
<td  width="30%">
	...
	<option value="<?php echo $tf['id_tfor']; ?>" <?php if (isset($_SESSION["crt_type_formation"]) and $_SESSION["crt_type_formation"] ==$tf['id_tfor']) echo ' selected="selected"'; ?>> <?php echo $tf['formation']; ?></option>
...
<td  width="30%">
	...
	<select name="fraicheur" id="fraicheur"> 
	  ...
	  <option value="30" <?php if(isset($_SESSION["crt_fraicheur"]) and $_SESSION["crt_fraicheur"]=="30") echo ' selected="selected"' ; ?>>1 mois</option>

	  <option value="90" <?php if(isset($_SESSION["crt_fraicheur"]) and $_SESSION["crt_fraicheur"]=="90") echo ' selected="selected"' ; ?>>3 mois</option>

	  <option value="180" <?php if(isset($_SESSION["crt_fraicheur"]) and $_SESSION["crt_fraicheur"]=="180") echo ' selected="selected"' ; ?>>6 mois</option>

	  <option value="360" <?php if(isset($_SESSION["crt_fraicheur"]) and $_SESSION["crt_fraicheur"]=="360") echo ' selected="selected"' ; ?>>12 mois</option>
...
<option value="<?php echo $Sector_id; ?>" <?php if (isset($_SESSION["crt_secteur"]) and $_SESSION["crt_secteur"] == $Sector_id) echo ' selected="selected"'; ?>>
...
<td  width="30%">
    ...
    <option value="<?php echo $pays_id; ?>"  <?php if (isset($_SESSION["crt_pays"]) and $_SESSION["crt_pays"] == $pays_id) echo ' selected="selected"'; ?>><?php echo $pays_desc; ?></option>
...
<td  width="30%">
	...
	<option value="<?php echo $reference; ?>" <?php if(isset($_SESSION["crt_ref"]) and $_SESSION["crt_ref"]==$reference) echo "selected='selected'"?> ><?php echo $reference.' | '.$ref_titre; ?></option>
...
<option value="<?php echo $Fonct_id; ?>" <?php if (isset($_SESSION['crt_fonction']) and $_SESSION['crt_fonction'] == $Fonct_id) echo ' selected="selected"'; ?>>
...
<td  width="30%">
	...
	<option value="<?php echo $ecole['id_ecole']; ?>" <?php if (isset($_SESSION['crt_etablissement']) and $_SESSION['crt_etablissement'] == $ecole['id_ecole']) echo ' selected="selected"'; ?>> <?php echo $ecole['nom_ecole']." || ".$ecole['pays']; ; ?></option>
...
<td  width="30%">
	...
	<?php if (isset($_SESSION['crt_ville']) and $_SESSION['crt_ville'] ==$ville) echo ' selected="selected"'; ?>>
...
<option value="<?php echo $nf_id; ?>" <?php if (isset($_SESSION["crt_formation"]) and $_SESSION["crt_formation"] == $nf_id) echo ' selected="selected"'; ?>><?php echo $nf_desc; ?></option>
...
<td  width="30%">
	...
	<option value="<?php echo $sa['id_situ']; ?>" <?php if (isset($_SESSION["crt_situation"]) and $_SESSION["crt_situation"] == $sa['id_situ']) echo ' selected="selected"'; ?>> <?php echo $sa['situation']; ?></option>
...
<td  width="30%">	
	...
	<?php if (isset($_SESSION['crt_campagne']) 

	and $_SESSION['crt_campagne'] ==$id_compagne) echo ' selected="selected"'; ?>>
...
?>	 
	...
	<select name="pertinence" id="pertinence" > 
	    ...
	    <option value="100" style="color:#00B300;" <?php if(isset($_SESSION["crt_pertinence"]) and $_SESSION["crt_pertinence"]=="100")  echo ' selected="selected"' ; ?>>Bonne</option> 

        <option value="60" style="color:#CC5500;" <?php if(isset($_SESSION["crt_pertinence"]) and $_SESSION["crt_pertinence"]=="60")   echo ' selected="selected"' ; ?>>Moyenne</option> 

        <option value="30" style="color:#CC0000;" <?php if(isset($_SESSION["crt_pertinence"]) and $_SESSION["crt_pertinence"]=="30")  echo ' selected="selected"' ; ?>>Faible</option> 
...
?>
      ...
      <select name="notation" id="notation" > 
        ...
        <option value="100" style="color:#00B300;" <?php if(isset($_SESSION["crt_notation"]) and $_SESSION["crt_notation"]=="100")  echo ' selected="selected"' ; ?>>Bonne</option>

        <option value="70" style="color:#CC5500;" <?php if(isset($_SESSION["crt_notation"]) and $_SESSION["crt_notation"]=="70")  echo ' selected="selected"' ; ?>>Moyenne</option> 

        <option value="40" style="color:#CC0000;" <?php if(isset($_SESSION["crt_notation"]) and $_SESSION["crt_notation"]=="40")  echo ' selected="selected"' ; ?>>Faible</option> 

        <option value="10" style="color:#000000;" <?php if(isset($_SESSION["crt_notation"]) and $_SESSION["crt_notation"]=="10")   echo ' selected="selected"' ; ?>>Null</option> 
...
<?php if($_SESSION['r_prm_region_off']==0){ ?> 
    ...
    <?php if (isset($_SESSION['crt_region']) and $_SESSION['crt_region'] ==$id_region) echo ' selected="selected"'; ?>>
...
<option value="<?php echo $age_id; ?>" <?php if (isset($_SESSION['crt_age']) and $_SESSION['crt_age'] == $age_id) echo ' selected="selected"'; ?>>
...
<option value="1" <?php if (isset($_SESSION['crt_sexe']) and $_SESSION['crt_sexe'] == "1") echo ' selected="selected"'; ?>>Homme</option>

<option value="2" <?php if (isset($_SESSION['crt_sexe']) and $_SESSION['crt_sexe'] == "2") echo ' selected="selected"'; ?>>Femme</option>
...
?>
    ...
    <?php if (isset($_SESSION['crt_region_ville']) and $_SESSION['crt_region_ville'] ==$ville) echo ' selected="selected"'; ?>>
...
<option value="<?php echo $exp_id; ?>" <?php if (isset($_SESSION["crt_exp"]) and $_SESSION["crt_exp"] == $exp_id) echo ' selected="selected"'; ?>><?php echo $exp_desc; ?></option>
