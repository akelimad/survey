...
<?php include('traitement_candidature_retenu_m_table_excel.php'); ?>

<?php } ?>

<table width="100%" id="traitement_candidature_en_retenu_table" class="tablesorter">
...
include('traitement_candidature_retenu_m_table_traitement.php'); 
...
?>
  ...
  <span style="width:550px;padding:6px"> 
...
<td>
      ...
      <?php include('traitement_candidature_retenu_m_table_notation.php'); ?>
