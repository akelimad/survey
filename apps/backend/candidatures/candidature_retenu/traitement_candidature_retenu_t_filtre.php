...
//------------------------------------------------------------------------------------------
if(isset($_POST["fonction"]) and $_POST["fonction"]!='')  $_SESSION["crt_fonction"]=$_POST["fonction"];  
if(isset($_POST["age"]) and $_POST["age"]!='')  $_SESSION["crt_age"]=$_POST["age"];  
if(isset($_POST["sexe"]) and $_POST["sexe"]!='')  $_SESSION["crt_sexe"]=$_POST["sexe"];  
/////////////////////////////////////////////////////////////////////////////////////////////
        ...
        if(!empty($_SESSION["crt_motcle"])||!empty($_SESSION["crt_fonction"])||!empty($_SESSION["crt_pertinence"])||!empty($_SESSION["crt_fraicheur"])
            ...
            ||!empty($_SESSION["crt_notation"])||!empty($_SESSION["crt_pays"])||!empty($_SESSION["crt_formation"])||!empty($_SESSION["crt_type_formation"])
			||!empty($_SESSION["crt_exp"])||!empty($_SESSION["crt_secteur"])||!empty($_SESSION["crt_situation"])||!empty($_SESSION["crt_etablissement"])||!empty($_SESSION["crt_ref"])
            ||!empty($_SESSION["crt_ville"])||!empty($_SESSION["crt_campagne"])
			||!empty($_SESSION["crt_age"])||!empty($_SESSION["crt_sexe"])
			)
  ...
  if(!empty($_SESSION["crt_sexe"]))
            
			{
			if($_SESSION['crt_sexe']=="1"){
			...
			//*************
			  if(!empty($_SESSION["crt_age"]))
            {
			
	if($_SESSION['crt_age']==1){
