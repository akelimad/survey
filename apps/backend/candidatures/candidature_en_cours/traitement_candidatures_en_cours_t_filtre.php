...
//------------------------------------------------------------------------------------------
if(isset($_POST["fonction"]) and $_POST["fonction"]!='')  $_SESSION["cc_fonction"]=$_POST["fonction"];  
if(isset($_POST["age"]) and $_POST["age"]!='')  $_SESSION["cc_age"]=$_POST["age"];  
if(isset($_POST["sexe"]) and $_POST["sexe"]!='')  $_SESSION["cc_sexe"]=$_POST["sexe"];  
/////////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////traitement filtrage/////////////////////////////////////////////////  
        ...
        if(!empty($_SESSION["cc_motcle"])||!empty($_SESSION["cc_fonction"])||!empty($_SESSION["cc_pertinence"])||!empty($_SESSION["cc_fraicheur"])
            ...
            ||!empty($_SESSION["cc_notation"])||!empty($_SESSION["cc_pays"])||!empty($_SESSION["cc_formation"])||!empty($_SESSION["cc_type_formation"])||!empty($_SESSION["cc_exp"])||!empty($_SESSION["cc_secteur"])||!empty($_SESSION["cc_situation"])||!empty($_SESSION["cc_etablissement"])||!empty($_SESSION["cc_ref"])
            ||!empty($_SESSION["cc_ville"])||!empty($_SESSION["cc_campagne"])
			|| !empty($_SESSION['cc_sexe']) || !empty($_SESSION['cc_age']))
		{
...
//---------------------------------age and sexe----------------------------------------------	
  ...
  if(!empty($_SESSION["cc_sexe"]))
            
			{
			if($_SESSION['cc_sexe']=="1"){
			...
			//*************
			  if(!empty($_SESSION["cc_age"]))
            {
			
	if($_SESSION['cc_age']==1){
