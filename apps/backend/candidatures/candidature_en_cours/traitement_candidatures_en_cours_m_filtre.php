...
<input class="espace_candidat" type="radio" <?php if(isset($_SESSION["cc_status"]) and $_SESSION["cc_status"]!="00000" and $_SESSION["cc_status"]==$status_btn_r["ref_statut"]) echo "checked" ?> name="f_status" value="<?php echo $status_btn_r["ref_statut"] ?>"   onchange='this.form.submit()' /> 

<?php echo " ".$status_btn_r["statut"]." "; ?>
...
<option value="<?php echo $Fonct_id; ?>" <?php if (isset($_SESSION['cc_fonction']) and $_SESSION['cc_fonction'] == $Fonct_id) echo ' selected="selected"'; ?>>
...
<option value="<?php echo $age_id; ?>" <?php if (isset($_SESSION['cc_age']) and $_SESSION['cc_age'] == $age_id) echo ' selected="selected"'; ?>>
...
<option value="1" <?php if (isset($_SESSION['cc_sexe']) and $_SESSION['cc_sexe'] == "1") echo ' selected="selected"'; ?>>Homme</option>

<option value="2" <?php if (isset($_SESSION['cc_sexe']) and $_SESSION['cc_sexe'] == "2") echo ' selected="selected"'; ?>>Femme</option>
