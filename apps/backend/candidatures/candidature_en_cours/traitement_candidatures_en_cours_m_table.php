...
<?php include('traitement_candidatures_en_cours_m_table_excel.php'); ?>

<?php } ?>



<table width="100%"  id="traitement_candidature_en_cours_table" class="tablesorter" >
...
<tr>
    ...
    <th  colspan="3" width="40%"><b>Informations Candidats</b></th> 

    <th   width="4%" ><b>Détails</b></th>
...
?>
    ...
    <th  width="1%"><b>Réf  </b></th>

    <th  width="20%" ><b>Titre du poste</b></th>

    <th  width="6%" class="sorter-shortDate dateFormat-ddmmyyyy"><center><b>Date</b></center></th>

    <th  width="12%"><center><b>Actions</b></center></th>
...
<tr <?php if($alter_class==1) {echo 'style="background-color:#E8F0F0"'; $alter_class++;} 
...
?>
  ...
  <span style="width:580px;padding:6px" id="span_w" style="visibility: visible;"> 
...
?>
     ...
     <td>
      ...
      <?php include('traitement_candidatures_en_cours_m_table_notation.php'); ?>
...
\''.$return['id_candidature'].'\',\''.$reponse['status'] .'\',\''.$stat .'\',\''. $percent .'\',

\''.$r_notation_1['note_ecole'] .'\',\''.$r_notation_1['note_filiere'] .'\',\''.$r_notation_1['note_diplome'] .'\',\''.$r_notation_1['note_experience'] .'\',\''.$r_notation_1['note_stages'] .'\',

\''.$r_notation_2['note_qualif'] .'\',\''.$r_notation_2['note_commun'] .'\',\''.$r_notation_2['note_compor'] .'\',

 \''.$sum_not1 .'\',\''.$sum_note2 .'\',\''.$sum_ffinal2 .'\')"
...
echo '<a href="'.$urladmin.'/popup/transferer_email/?email='.$r_root_roles['email'].'&cv='.$r_cv['titre_cv'].'&lm='.$r_lettres_motivation['lettre'].'" title="Transf&eacute;rer le cv">
...
$piece_j = $postit01['piece_j'];

$piece_j1 = $postit01['piece_j1'];

$piece_j2 = $postit01['piece_j2'];

$piece_j3 = $postit01['piece_j3'];

$piece_j4 = $postit01['piece_j4'] ;  

            

if(($piece_j != '') or ($piece_j1 != '') or ($piece_j2 != '') or ($piece_j3 != '') or ($piece_j4 != '')  )
...
<input name="select_candidature[]" id="select<?php echo $i; ?>" type="checkbox" 

value="<?php echo $return['id_candidature']; ?>" 

onclick="colorer('<?php echo $i; ?>')" 

<?php if(isset($_POST['candidature']) 

&& ($return['id_candidature'] == $_POST['candidature'])) echo 'checked'; ?> />
  ...
  Pour la sélection : 
    ...
    <div class="ligneBleu" style="  float: left;" ></div>
     ...
     <?php
        ...
        echo '<tr class="sectiontableentry1"><td colspan="9" align="center">Aucune candidature</td></tr></tbody></table>'; 
