...
//------------------------------------------------------------------------------------------
if(isset($_POST["fonction"]) and $_POST["fonction"]!='')  $_SESSION["cnr_fonction"]=$_POST["fonction"];  
if(isset($_POST["age"]) and $_POST["age"]!='')  $_SESSION["cnr_age"]=$_POST["age"];  
if(isset($_POST["sexe"]) and $_POST["sexe"]!='')  $_SESSION["cnr_sexe"]=$_POST["sexe"];  
/////////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////traitement filtrage/////////////////////////////////////////////////  
        ...
        if(!empty($_SESSION["cnr_motcle"])||!empty($_SESSION["cnr_fonction"])||!empty($_SESSION["cnr_pertinence"])||!empty($_SESSION["cnr_fraicheur"])||!empty($_SESSION["cnr_notation"])||!empty($_SESSION["cnr_pays"])||!empty($_SESSION["cnr_formation"])
            ||!empty($_SESSION["cnr_region"])||!empty($_SESSION["cnr_region_ville"])
            ||!empty($_SESSION["cnr_type_formation"])||!empty($_SESSION["cnr_exp"])||!empty($_SESSION["cnr_secteur"])||!empty($_SESSION["cnr_situation"])||!empty($_SESSION["cnr_etablissement"])||!empty($_SESSION["cnr_ref"])
            ||!empty($_SESSION["cnr_ville"])||!empty($_SESSION["cnr_campagne"])
			||!empty($_SESSION['cnr_sexe']) || !empty($_SESSION['cnr_age']))
        {
...
//---------------------age and sexe----------------------------------------------	
 ...
 if(!empty($_SESSION["cnr_sexe"]))
            
			{
			if($_SESSION['cnr_sexe']=="1"){
			...
			//*************
	if(!empty($_SESSION["cnr_age"]))
            {
			
	if($_SESSION['cnr_age']==1){
