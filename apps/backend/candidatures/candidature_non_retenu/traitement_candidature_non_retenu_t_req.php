...
$result_array =  $array_test =  array();
            ...
            $select_popup_3 = mysql_query("SELECT statut FROM `prm_statut_candidature` where  popup_6=6" );
		...
		$qury_cand____1="SELECT   candidature.candidats_id , candidature.id_candidature,  candidature.id_offre  FROM   candidature  ". $tbl____o . $q_offre_fili ." ".$offre_candidatures. $where____and.$o____c."      candidature.status in ('Non retenu', 'Refuse')     ";
     ...
     $clos__cond = " and "; if(!empty($o____c)) $clos__cond = $where____and.$o____c;
        ...
        $query = "SELECT  
			candidature.candidats_id , candidature.id_candidature,  candidature.id_offre 
			 FROM   candidature    ".$tbl____o.$condition."   ".$q_offre_fili_and. $clos__cond ."   candidature.status in ('Non retenu', 'Refuse') "; 
