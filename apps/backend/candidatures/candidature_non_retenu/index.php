<?php   	include("./traitement_candidature_non_retenu_t.php");  ?>
...
<?php include ("./traitement_candidature_non_retenu_m.php"); ?>
</div> 
</div>
<?php include ( dirname(__FILE__) . $tempurl2 . "/footer_admin.php"); ?>
<?php include ( "./traitement_candidature_non_retenu_b.php");
