...
<?php include ("./note_off_m_table.php"); ?>
 ...
 <?php
     ...
     // $sql_off="SELECT * FROM offre WHERE id_offre IN ( SELECT   id_offre   FROM   candidature  GROUP BY  id_offre  ) ".$q_ref_fili_and." ";

			

           $sql = mysql_query($sql_off);
