...
table.tablesorter tbody td {color: #3D3D3D;background-color: #e8f0f0;vertical-align: top;}
...
table thead th, table tfoot th {background-color: <?php echo $bg1; ?> !important;color:#fff;!important }

table thead th, table tfoot th b{color:#fff;!important }

table thead th, table tfoot th strong{color:#fff;!important }
...
.pagination>.active>a, .pagination>.active>a:focus, .pagination>.active>a:hover, .pagination>.active>span, .pagination>.active>span:focus, .pagination>.active>span:hover {
  ...
  color: #fff;
  cursor: default;
  background-color: <?php echo $bg1; ?> !important;
  border-color: <?php echo $bg1; ?> !important;
}
