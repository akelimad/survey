<?php
   ...
   header('Cache-Control: max-age=31536000, must-revalidate'); 
	...
	$bg1=$color_bg;
?>
body{background-color:<?php echo $bg0; ?>;margin:0;padding:0;overflow:scroll;}
#container{position:relative;margin:-1px auto;width:1035px;padding:0 10px;}
...
#gauche{float:left;width:1035px !important;margin:0px 0 5px;font-family:Verdana, Arial, Helvetica, sans-serif;font-size:11px;color:#000;}
...
#block_search{width:650px;height:100px;padding:6px 0 0;background-color:#F7F7F7;margin-top:0px;-moz-border-radius-topleft:8px;-moz-border-radius-topright:8px;-webkit-border-top-left-radius:8px;-webkit-border-top-right-radius:8px;}
...
#annonces{position:relative;height:387.5px;*height:599px;padding:10px;overflow:auto;background-color:#FFFFFF;border:1px solid #ccc;}
...
#content_g{float:left;width:213px;padding-top:0px;}
#content_d{float:left;width:400px;margin-left:100px;text-align:left;}
...
#content_d li{  padding: 2px 1px;
  /*margin: 0 57px;*/
  list-style-type: disc;}
#content_d p{margin-top:0;  font-size: 12px;
  line-height: 20px;
  padding: 0px 20px;}
...
.clear{clear:both;}
.odd1{background-color:#ddd;}
.even1{background-color:#E6EEEE;}
.tableentete1{background-color:#e6EEEE;border:1px solid #FFF;font-size:8pt;padding:4px;background-repeat:no-repeat;background-position:center right;cursor:pointer;}
.tableentete{background-color:#e6EEEE;border:1px solid #FFF;font-size:8pt;padding:4px;}
#candidature{background-color:#e8f0f0;margin:10px 0 15px;width:100%;text-align:left;}
.marked td{background-color:#FC9;}
.headerSortUp1{background-color:#e6EEEE;border:1px solid #FFF;font-size:8pt;padding:4px; background-repeat:no-repeat;background-position:center right;cursor:pointer;}
.headerSortDown1{background-color:#e6EEEE;border:1px solid #FFF;font-size:8pt;padding:4px; background-repeat:no-repeat;background-position:center right;cursor:pointer;}
table.tablesorter, #chm-table{background-color:#fff;margin:10px 0 15px;width:100%;text-align:left;}
...
table.tablesorter tbody td, #chm-table tbody td{color:#3D3D3D;background-color:#fff;vertical-align:top;}
...
.popup_block{overflow:auto;position:fixed;_position:absolute;background-color:#fff;-moz-border-radius-topleft:10px;-moz-border-radius-topright:10px;top:200px;left:200px;z-index:999;}
...
#fade{background:#000;position:fixed;_position:absolute;width:100%;height:100%;filter:alpha(opacity=80);opacity:.80;-ms-filter:"progid:DXImageTransform.Microsoft.Alpha(Opacity=80)";left:0;top:0;z-index:10;}
...
a.info #description{display:none;}
a.info:hover{background:none;z-index:999;cursor:pointer;}
a.info:hover #description{display:inline;position:absolute;background:white;color:black;padding:3px;border:1px solid black}
div.desactive{background-color:red;}
a.info{position:relative;color:#000;text-decoration:none}
a.info:hover{background-color:#ff0}
a.info span{display:none}
a.info:hover span{display:block;position:absolute;bottom:1em;left:1em;width:15em;border:1px solid #6699cc;background-color:#eeeeee;color:#6699cc;text-align:justify;font-weight:none;padding:1px;}
a.info1 #description{display:none;}
a.info1:hover{background:none;z-index:999;cursor:pointer;}
a.info1:hover #description{display:inline;position:absolute;background:white;color:black;padding:3px;border:1px solid black}
div.desactive{background-color:red;}
a.info1{position:relative;color:#000;text-decoration:none}
a.info1:hover{background-color:#ff0}
a.info1 span{display:none}
a.info1:hover span{display:block;position:absolute;bottom:1em;right:1em;width:15em;border:1px solid #6699cc;background-color:#eeeeee;color:#6699cc;text-align:justify;font-weight:none;padding:1px;}
#navbar{height:30px;}
#navbar ul{margin:0;padding:0;list-style:none;}
#navbar ul li{display:inline;}
#navbar ul li a{float:left;color:#fff;height:18px;margin:0 0 0 5px;border:1px solid #000;padding:5px 20px;text-decoration:none;background:#000;}
#navbar ul li a:hover,
#navbar ul li a.active,
#navbar ul li a.active:hover{color:#000;border:1px solid #000;background:#fff;}
#navbar ul li:first-child a{margin-left:0;}
#feedback_lightbox{width:350px;z-index:9999;position:relative;top:20%;left:30%;}
#feedback_overlay_box{position:fixed;top:0;left:0;background:rgba(0, 0, 0, 0.8);overflow:hidden;z-index:9998;width:100%;display:none;height:100%;}
#feedback_button{width:22px;height:90px;position:fixed;top:40%;overflow:hidden;}
#feedback_button a{width:22px;height:90px;overflow:hidden;background:  #FCB03F;display:inline-block;padding:px;border-radius:0 5px 5px 0;display:block;height:90px;line-height:0;text-indent:-99999px;}
#feedback_close{ border-top-left-radius:10px;border-top-right-radius:10px;height:25px;margin:0;width:340px}
#feedback_close a{background-image:url("../images/close-b.jpg");background-repeat:no-repeat;float:right;font-size:0;height:13px;line-height:30px;margin-right:7px;margin-top:5px;overflow:hidden;text-indent:-10000px;width:13px;}
#feedback_form{width:280px;background:#ffffff ;-webkit-box-shadow:1px 4px 4px rgba(0, 0, 0, 0.1);-moz-box-shadow:1px 4px 4px rgba(0, 0, 0, 0.1);box-shadow:1px 4px 4px rgba(0, 0, 0, 0.1);padding:30px;}
#feedback_form p{padding:0px 0px 10px 0px;margin:0px;display:block;}
#feedback_form p label{display:block;font-size:12px;line-height:16px;padding:0px 0px 3px 0px;color:red;}
#feedback_form p .feedback_text,#feedback_form p .feedback_textarea{border:1px solid #999999;}
#feedback_error{margin:10px 0px 0px 0px;border:1px solid red;padding:10px;overflow:hidden;display:none;}
#feedback_response{margin:10px 0px 10px 0px;border:1px solid green;padding:10px;color:green;overflow:hidden;display:none;}
#alternate-account{margin:0;padding:0;vertical-align:top;width:100%;}
#alternate-account div{background:url(../images/facebook-body.png) repeat-y 0 0;background-size:222px 10px;}
#alternate-account li{margin:0;padding:0;list-style-type:none;line-height:0;overflow:hidden;color:#525252;font:12px/1.5 Arial, Sans-serif;}
#alternate-account li{cursor:pointer;}
#alternate-account ul{margin:0;padding:0;overflow:auto;list-style-type:disc;line-height:1.4;color:#525252;font:12px/1.5 Arial, Sans-serif;list-style:none;}
#alternate-account fieldset{padding:0 0 30px 36px;background:url(../images/facebook-bottom.png) no-repeat 0 100%;background-size:222px 5px;border:0;}
#alternate-account h1{margin:0;padding:16px 0 20px 36px;background:url(../images/facebook-top.png) no-repeat 0 0;background-size:222px 60px;font-size:20px;line-height:1.2;color:#333;font-weight:normal}
#alternate-account div img{margin:0;padding:0;border:0;outline:0;font-weight:inherit;font-style:inherit;font-size:100%;font-family:inherit;vertical-align:baseline;}
.tableentete2{background-color:#1768AB;font-size:8pt;padding:4px;background-repeat:no-repeat;background-position:center right;cursor:pointer;}
.headerSortUp2{background-color:#1768AB;font-size:8pt;padding:4px; background-repeat:no-repeat;background-position:center right;cursor:pointer;}
.headerSortDown2{background-color:#1768AB;font-size:8pt;padding:4px; background-repeat:no-repeat;background-position:center right;cursor:pointer;}
.meter{background:none repeat scroll 0 0 #555555;border-radius:25px 25px 25px 25px;box-shadow:0 -1px 1px rgba(255, 255, 255, 0.3) inset;height:20px;margin:60px 0 20px;padding:10px;position:relative;}
.meter > span{display:block;height:100%;-webkit-border-top-right-radius:8px;-webkit-border-bottom-right-radius:8px;-moz-border-radius-topright:8px;-moz-border-radius-bottomright:8px;border-top-right-radius:8px;border-bottom-right-radius:8px;-webkit-border-top-left-radius:20px;-webkit-border-bottom-left-radius:20px;-moz-border-radius-topleft:20px;-moz-border-radius-bottomleft:20px;border-top-left-radius:20px;border-bottom-left-radius:20px;background-color:rgb(43,194,83);background-image:-webkit-gradient(linear,
left bottom,
left top,
...
#nav li:hover ul.sub{left:0;top:31px;background:#DDD8D5;padding:3px;border:1px solid white;white-space:nowrap;width:184px;height:auto;z-index:4;}
#nav li:hover ul.sub li{display:block;height:20px;position:relative;float:left;width:184px;font-weight:normal;}
#nav li:hover ul.sub li a{display:block;font-size:10px;height:20px;width:184px;line-height:20px;text-indent:5px;color:#765B52;text-decoration:none;font-weight:bold;}
#nav li ul.sub li a.fly{background:#fff  ;}
#nav li:hover ul.sub li a:hover{background:#F0ECEB;color:#CD6408;}
#nav li:hover ul.sub li a.fly:hover{background:#E1DCD9 ;color:#765B52;}
#nav li:hover ul li:hover > a.fly{background:#3a93d2  ;color:#fff;}
#nav li:hover ul li:hover ul,
#nav li:hover ul li:hover ul li:hover ul,
#nav li:hover ul li:hover ul li:hover ul li:hover ul,
#nav li:hover ul li:hover ul li:hover ul li:hover ul li:hover ul{left:90px;top:-4px;background:#fff;padding:3px;border:1px solid #3a93d2;white-space:nowrap;width:200px;z-index:4;height:auto;}
html{font-size:0.625em;}
body{margin:0;padding:0;font-size:1.2em;font-family:Arial, Verdana, sans-serif;color:#000000; }
...
.quicknavigation{padding:10px 0 0 0;text-align:center;background:<?php echo $bg1; ?>;font-size:0.917em;min-height:26px;background-color:<?php echo $bg1; ?>;}
...
.quicknavigation .rsscontact{display:inline;float:right;width:34.5em;}
...
.quicknavigation .rsscontact .contactus a{padding:0 0 2px 12px;text-decoration:underline;font-weight:bold;}
...
.quicknavigation .rsscontact .acces a{ padding:0 0 2px 68px;text-decoration:underline;font-weight:bold;}
.quicknavigation .rsscontact .acces a:hover{text-decoration:none;}
.socialHub{display:inline;float:left;padding:0 5px;white-space:nowrap;}
...
.quicknavigation .socialHub{color:#765B52 !important;font-weight:900;}
.DynarchCalendar-title, .DynarchCalendar-menu-year{margin-left:50px;}
.cu{cursor:pointer;}
.csscaree{width: 8px;height: 7px;background: <?php echo $bg1; ?>;margin-right: 5px;}
...
.souspuce{content: '';border: 4px transparent solid;border-right-width: 0;border-left-color: <?php echo $bg1; ?>; right: 2px;top: 3px;float:left;position:relative;}

.espace_candidat{color: #fff;cursor: pointer;font-weight: 400;padding: 4px 10px;
position: relative;background: <?php echo $bg1; ?>;
white-space: nowrap;display: inline-block;
text-decoration: none;}
.identifier{color: #fff;cursor: pointer;font-weight: 400;padding: 2px 0px;
position: relative;background: <?php echo $bg1; ?>;
white-space: nowrap;display: inline-block;
text-decoration: none;}
.but_fiche_profil{color: #fff;cursor: pointer;font-weight: 400;padding: 1px 10px;
position: relative;background: <?php echo $bg1; ?>;
white-space: nowrap;display: inline-block;
text-decoration: none;}
.titre_offre{color:<?php echo $bg1; ?>;font-size:14px;}
.lien_candidat{color:<?php echo $bg1; ?>;}
.copyright{color:#fff;}
...
#form_contact input:focus:invalid,select:focus:invalid, #signup textarea:focus:invalid { 
    background: #fff url(../images/ico_validation.png) no-repeat 100% center;
    border: 1px solid red;
}

#form_contact input:required:valid,select:required:valid, #signup textarea:required:valid { 
    background: #fff url(../images/valid.png) no-repeat 100% center;
    box-shadow: 0 0 5px #5cd053;
    border-color: #28921f;
}

#form_candidat input:focus:invalid,select:focus:invalid, #signup textarea:focus:invalid { 
    background: #fff url(../images/ico_validation.png) no-repeat 100% center;
    border: 1px solid red;
}

#form_candidat input:required:valid,select:required:valid, #signup textarea:required:valid { 
    background: #fff url(../images/valid.png) no-repeat 100% center;
    box-shadow: 0 0 5px #5cd053;
    border-color: #28921f;
}

#form_inscription input:focus:invalid,select:focus:invalid, #signup textarea:focus:invalid { 
    background: #fff url(../images/ico_validation.png) no-repeat 100% center;
    border: 1px solid red;
}
#form_inscription input:required:valid,select:required:valid, #signup textarea:required:valid { 
    background: #fff url(../images/valid.png) no-repeat 100% center;
    box-shadow: 0 0 5px #5cd053;
    border-color: #28921f;
}

#form_standard input:focus:invalid,select:focus:invalid, #signup textarea:focus:invalid { 
    background: #fff url(../images/ico_validation.png) no-repeat 100% center;
    border: 1px solid red;
}
#form_standard input:required:valid,select:required:valid, #signup textarea:required:valid { 
    background: #fff url(../images/valid.png) no-repeat 100% center;
    box-shadow: 0 0 5px #5cd053;
    border-color: #28921f;
}
