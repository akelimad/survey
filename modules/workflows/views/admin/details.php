...
<div class="row">
	...
	<div class="col-md-6">
		...
		<form action="" method="post" class="pull-right">
			...
			<button type="submit" class="btn btn-primary btn-sm"><?php trans_e("Changer"); ?></button>
		</form>
		<?php endif; ?>
	</div>
</div>
...
<div class="panel panel-default mt-20" style="margin-bottom: 10px;">
	<div class="panel-body">
		<h5 style="margin: 0px;"><strong><?php trans_e("Détails de l'offre"); ?></strong></h5><hr>
		<ul class="list-group" style="margin-bottom: 0px;">
			<li class="list-group-item list-group-item-info">
				<div class="row">
					<div class="col-md-2"><?php trans_e("Référence"); ?></div>	
					<div class="col-md-10"><?= $offre->reference; ?></div>	
				</div>
			</li>
			<li class="list-group-item">
				<div class="row">
					<div class="col-md-2"><?php trans_e("Titre de l'offre"); ?></div>	
              ...
              <input name="action" type="hidden" value="">
							<button type="submit" class="btn btn-info btn-xs"><i class="fa fa-edit"></i>&nbsp;<?php trans_e("Modifier l'offre"); ?></button>
						</form>
					</div>	
				</div>
			</li>
			<li class="list-group-item list-group-item-info">
				<div class="row">
					<div class="col-md-2"><?php trans_e("Date d’insertion"); ?></div>	
					<div class="col-md-10"><?= date('d/m/Y', strtotime($offre->date_insertion)); ?></div>	
				</div>
			</li>
			<li class="list-group-item">
				<div class="row">
					<div class="col-md-2"><?php trans_e("Date d’expiration"); ?></div>	
					<div class="col-md-10"><?= date('d/m/Y', strtotime($offre->date_expiration)); ?></div>	
				</div>
			</li>
			<li class="list-group-item list-group-item-info">
				<div class="row">
					<div class="col-md-2"><?php trans_e("Mobilité"); ?></div>	
					<div class="col-md-10"><?= $offre->mobilite; ?></div>	
				</div>
			</li>
			<li class="list-group-item">
				<div class="row">
					<div class="col-md-2"><?php trans_e("Statut courant"); ?></div>	
...
<div class="panel panel-default" style="margin-bottom: 10px;">
	<div class="panel-body">
		<h5 style="margin: 0px;"><strong><?php trans_e("Historique des changements de statut"); ?></strong></h5><hr>
		<ul class="list-group" style="margin-bottom: 0px;">
			<li class="list-group-item list-group-item-info">
				<div class="row">
					<div class="col-md-2"><strong><?php trans_e("Agent"); ?></strong></div>	
					<div class="col-md-2"><strong><?php trans_e("Date de changement"); ?></strong></div>	
					<div class="col-md-2"><strong><?php trans_e("Statut"); ?></strong></div>	
					<div class="col-md-6"><strong><?php trans_e("Note"); ?></strong></div>	
				</div>
			</li>
