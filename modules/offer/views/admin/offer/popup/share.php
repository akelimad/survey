<form action="<?= site_url('backend/module/offer/offer/share'); ?>" method="post" onsubmit="return window.chmForm.sumbit(event)">
	...
	<div class="row mb-5">
		<label for="share_receiver" class="col-md-4">Partenaire&nbsp;<font style="color:red;">*</font></label>
		<div class="col-md-5">
