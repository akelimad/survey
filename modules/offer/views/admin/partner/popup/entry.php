...
<div class="row mb-10">
  <label for="last_name" class="col-md-3">Nom candidat</label>
  <div class="col-md-9">
...
<div class="row mb-10">
  <label for="first_name" class="col-md-3">Prénom candidat</label>
  <div class="col-md-9">
...
<div class="row mb-10">
  <label for="cin" class="col-md-3">CIN</label>
  <div class="col-md-9">
...
<div class="row mb-10">
  <label for="mobile" class="col-md-3">Téléphone</label>
  <div class="col-md-9">
    ...
    <table class="table">
      <tbody>
        ...
        <tr>
          ...
          <td><a href="<?= site_url('uploads/partner/entries/'. $entry->id_entry .'/'.$value); ?>" target="_blank"><i class="fa fa-download"></i>&nbsp;Télécharger</a></td>
          <td>
            <button type="button" class="btn btn-danger btn-xs" onclick="return window.chmModal.confirm(this, '', 'Êtes-vous sûr de vouloir supprimer cette pièce joint ?', 'chmOffer.deleteEntryAttachement', {eid: '<?= $entry->id_entry; ?>', roid: '<?= $id_role_offre; ?>', 'title': '<?= $attach_title; ?>'}, {width:315})"><i class="fa fa-trash"></i></button>
          </td>
        </tr>
        <?php endforeach; endif; ?>
        <tr>
          <td width="150" style="padding: 4px 2px;"><input type="text" name="titles[]" placeholder="Titre (CV, Lettre de motivation...)"></td>
