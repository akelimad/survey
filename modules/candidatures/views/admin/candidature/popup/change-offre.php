<form action="" method="post">
	...
	<div class="row mb-15">
		<label for="change_offre" class="col-md-3">Choisissez un offre&nbsp;<font style="color:red;">*</font></label>
		<div class="col-md-9">
	...
	<div class="form-group mt-10 mb-0">
	    ...
	    <button type="submit" class="btn btn-primary btn-sm pull-right">Mettre à jour</button>
	</div>
</form>